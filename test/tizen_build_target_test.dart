...
''');
      ...
      when(mockTizenSdk.certificateProfiles)
          .thenReturn(CertificateProfiles.parseFromXml(certificatesXml));
      when(mockTizenSdk.certificateProfilesFile).thenReturn(certificatesXml);
